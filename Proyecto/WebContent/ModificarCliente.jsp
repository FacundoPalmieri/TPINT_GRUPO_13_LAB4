    ...
    <form action="EditarCliente" method="post" style="max-width: 800px; width: 100%;">
        ...
        <div class="panel">
            ...
            <div class="form-group" style="margin-top:10px;">
                ...
                <input type="password" id="pass" name="pass" value="<%= usuario != null ? usuario.getPass() : "" %>" >
            </div>
            
             <div class="form-group" style="margin-top:10px;">
                <label for="pass">Reingrese Contraseña:</label>
                <input type="password" id="pass2" name="pass2" value="<%= usuario != null ? usuario.getPass() : "" %>" >
            </div>
        </div>
	 ...
	 <!-- OBTENGO EL ID DE LA DIRECCION -->
		<% if(direccion != null && direccion.getId() != 0){ %>
		    <input type="hidden" name="idDireccion" value="<%= direccion.getId() %>">
		<% } %>
